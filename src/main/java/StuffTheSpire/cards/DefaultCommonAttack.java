...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = StuffTheSpireMod.makeID("DefaultCommonAttack");
    ...
    // The list of all of them can be found in the main StuffTheSpireMod.java file in the
