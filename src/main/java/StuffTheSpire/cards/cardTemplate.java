...
public class cardTemplate extends AbstractDefaultCard {
    ...
    public static final String ID = StuffTheSpireMod.makeID("DefaultCommonAttack"); // StuffTheSpireMod.makeID("${NAME}");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = StuffTheSpireMod.makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("${NAME}.png");
