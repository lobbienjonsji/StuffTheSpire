...
public class CommonPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = StuffTheSpireMod.makeID("CommonPower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(StuffTheSpireMod.makePowerPath("placeholder_power84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(StuffTheSpireMod.makePowerPath("placeholder_power32.png"));
