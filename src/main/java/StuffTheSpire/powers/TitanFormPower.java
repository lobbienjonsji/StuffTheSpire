...
public class TitanFormPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = StuffTheSpireMod.makeID("Titan");
    ...
    public TitanFormPower(final AbstractCreature owner, final AbstractCreature source, int amount) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
