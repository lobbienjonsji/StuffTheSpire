...
public class DefaultOrb extends AbstractOrb {
    ...
    public static final String ORB_ID = StuffTheSpireMod.makeID("DefaultOrb");
    private static final OrbStrings orbString = CardCrawlGame.languagePack.getOrbString(ORB_ID);
    public static final String[] DESC = orbString.DESCRIPTION;

    private static final Texture IMG = TextureLoader.getTexture(StuffTheSpireMod.makeOrbPath("default_orb.png"));
