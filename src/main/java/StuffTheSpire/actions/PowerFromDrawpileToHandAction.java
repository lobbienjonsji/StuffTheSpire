...
public class PowerFromDrawpileToHandAction extends AbstractGameAction {
    ...
    public PowerFromDrawpileToHandAction(int amount, boolean isNotRandom) {
    ...
    public void update() {
        ...
        if (this.duration == Settings.ACTION_DUR_MED) {
            ...
            if (isNotRandom) {
                ...
                AbstractCard c = tmp.getRandomCard(AbstractCard.CardType.POWER, true);
                c.unhover();
