...
public class IdentityCrisisEvent extends AbstractImageEvent {
    ...
    public static final String ID = StuffTheSpireMod.makeID("IdentityCrisisEvent");
    private static final EventStrings eventStrings = CardCrawlGame.languagePack.getEventString(ID);

    private static final String NAME = eventStrings.NAME;
    private static final String[] DESCRIPTIONS = eventStrings.DESCRIPTIONS;
    private static final String[] OPTIONS = eventStrings.OPTIONS;
    public static final String IMG = StuffTheSpireMod.makeEventPath("IdentityCrisisEvent.png");
            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    ...
                    case 3: // If you press button the fourth button (Button at index 3), in this case: TOUCH
                        imageEventText.loadImage("StuffTheSpireResources/images/events/IdentityCrisisEvent2.png"); // Change the shown image
